...
<head>
    ...
    <link href="<?php echo base_url('assets/frontend/css/blog.css'); ?>" rel="stylesheet">
        ...
        <!-- Custom Fonts -->
    <link href="<?php echo base_url('assets/frontend/css/font-awesome/css/font-awesome.css'); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo base_url('assets/frontend/css/font-awesome/css/font-awesome.css'); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo base_url('assets/frontend/fonts/glyphicons-halflings-regular.woff2'); ?>" rel="stylesheet" type="text/css">
